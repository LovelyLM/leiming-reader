    ...
    <div class="container mt-2 p-2 m-0">
        <form id="frmLogin">
            <div class="passport bg-white">
                ...
                <div class="input-group mt-4 ">
                    <div class="col-5 p-0">
                        <input type="text" id="verifyCode" name="captcha" class="form-control p-4" placeholder="验证码">
                    </div>
                    <div class="col-4 p-0 pl-2 pt-0">
                        <img id="imgVerifyCode" src="/getCaptcha"
...
<script>
    ...
    function reloadVerifyCode(){
        $("#imgVerifyCode").attr("src", "/getCaptcha?ts=" + new Date().getTime());
    }
